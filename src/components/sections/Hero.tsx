  ...
  return (
    <section id="hero" className="relative min-h-screen w-full flex flex-col justify-center bg-bg-primary pt-24 px-6 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto w-full z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        {/* Left Side: Content */}
        <div className="flex flex-col items-start justify-center pt-10 lg:pt-0 lg:col-span-7">
          <motion.h2 
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
            className="font-arabic text-3xl md:text-4xl text-emerald-primary mb-6 opacity-90"
          >
          ...
          >
            <a href="#programs">
              <HoverBorderGradient
                ...
                as="button"
                className="bg-bg-secondary text-text-primary flex items-center space-x-2 px-8 py-3 font-medium hover:bg-bg-primary transition-colors"
              >
                <span>Jelajahi Program</span>
              </HoverBorderGradient>
            </a>
            
            <a href="#infaq" className="text-text-secondary hover:text-text-primary transition-colors flex items-center gap-2 group font-medium">
        ...
        <motion.div 
          ...
          className="relative w-full aspect-video lg:aspect-[4/3] flex items-center justify-center rounded-3xl overflow-hidden border border-border bg-bg-secondary  group lg:col-span-5 max-w-lg mx-auto lg:mx-0 justify-self-end"
        >
          {/* Explicit Placeholder Design */}
          <div className="absolute inset-4 rounded-2xl border-2 border-dashed border-border flex flex-col items-center justify-center bg-bg-primary/30 group-hover:bg-bg-primary/50 transition-colors">
            ...
            <p className="font-display font-bold text-text-primary text-lg tracking-wide">Foto Musholla</p>
